...
const skills: Skill[] = [
  ...
  },
  {
    ...
    icon: "liquid",
    level: "Expert",
    description: "Shopify's templating language for dynamic e-commerce themes",
    color: "text-cyan-500",
  },
  {
    name: "Shopify",
    ...
    level: "Advanced",
    description:
      "E-commerce platform development, themes, and custom app integrations",
    color: "text-green-500",
  },
];
...
const additionalSkills = [
  ...
  { name: "Shopify Apps", category: "Tools" },
  { name: "Shopify Themes", category: "Frontend" },
