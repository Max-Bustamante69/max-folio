...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/maximiliano-bustamante', // Placeholder - update with real URL
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/maximiliano-bustamante', // Placeholder - update with real URL
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/maximiliano_dev', // Placeholder - update with real URL
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground">Maximiliano Bustamante</h3>
                  <p className="text-sm text-muted-foreground">Software Engineer & Frontend Developer</p>
                </div>
              </div>

              <p className="text-muted-foreground leading-relaxed">
                Crafting exceptional digital experiences with modern technologies. 
                Passionate about creating scalable, beautiful, and performant web applications 
        ...
        <div className="border-t border-border/50 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© {currentYear} Maximiliano Bustamante. Made with</span>
